 ...
 *
 *=========================================================================*/
#ifndef __itkMattesNormalizedMutualInformationImageToImageMetric_hxx
#define __itkMattesNormalizedMutualInformationImageToImageMetric_hxx

#include "itkMattesNormalizedMutualInformationImageToImageMetric.h"
...
MattesNormalizedMutualInformationImageToImageMetric<TFixedImage, TMovingImage>
::MattesNormalizedMutualInformationImageToImageMetric() :
...
template <typename TFixedImage, typename TMovingImage>
typename MattesNormalizedMutualInformationImageToImageMetric<TFixedImage, TMovingImage>
::MeasureType
MattesNormalizedMutualInformationImageToImageMetric<TFixedImage, TMovingImage>
                        ...
                        DerivativeType & derivative) const
{
  ...
  PDFValueType sum = 0.0;
  //PDFValueType sum_me = 0.0;
  //PDFValueType sum_je = 0.0;
  ...
  for( unsigned int fixedIndex = 0;
    ...
    for( unsigned int movingIndex = 0;
      ...
      const PDFValueType movingImagePDFValue = this->m_MovingImageMarginalPDF[movingIndex];
      const PDFValueType jointPDFValue = *( jointPDFPtr );
      //std::cout<<fixedIndex<<" "<<movingIndex<<" jointPDFValue= "<<jointPDFValue<<"\n";
      ...
      if( jointPDFValue > closeToZero &&  movingImagePDFValue > closeToZero )
        ...
        if( fixedImagePDFValue > closeToZero )
          {
          sum += jointPDFValue * ( pRatio - vcl_log(fixedImagePDFValue) );
          //sum_je += jointPDFValue * ( -vcl_log(jointPDFValue) );
          //sum_me += jointPDFValue * ( -vcl_log(movingImagePDFValue) - vcl_log(fixedImagePDFValue) );
          }
  ...
  //std::cout<<"iteration= "<<this->num_iterations<<"\n";
  //this->num_iterations += 1;
  value = static_cast<MeasureType>( -1.0 * sum );
  //std::cout<<"NMI= "<<-1.0*(sum_me/sum_je)<<"\n";
  //value = static_cast<MeasureType>( -1.0 * (sum_me/sum_je) );
}

...
public:
  ...
  /** Optimizer Type. */
  typedef QuaternionRigidTransformGradientDescentOptimizerStoppingCriterion 
                                                         OptimizerType;
  ...
  typedef MattesNormalizedMutualInformationImageToImageMetric< 
                                    FixedImageType, 
                                    MovingImageType >    MattesNMIMetricType;
  
  typedef MattesMutualInformationImageToImageMetric< 
                                    FixedImageType, 
                                    MovingImageType >    MattesMIMetricType;

  typedef MutualInformationImageToImageMetric< 
                                    FixedImageType, 
                                    MovingImageType >    ViolaMIMetricType;
...
private:
  ...
  typename ViolaMIMetricType::Pointer         m_ViolaMetric;
  typename MattesNMIMetricType::Pointer       m_NMattesMetric;
  typename MattesMIMetricType::Pointer        m_MattesMetric;

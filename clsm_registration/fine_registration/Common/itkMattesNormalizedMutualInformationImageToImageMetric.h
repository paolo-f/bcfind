 ...
 *
 *=========================================================================*/
#ifndef __itkMattesNormalizedMutualInformationImageToImageMetric_h
#define __itkMattesNormalizedMutualInformationImageToImageMetric_h
...
namespace itk
{
/** \class MattesNormalizedMutualInformationImageToImageMetric
 * \brief Computes the mutual information between two images to be
 * registered using the method of Mattes et al.
 *
 * MattesNormalizedMutualInformationImageToImageMetric computes the mutual
...
public:
  ...
  typedef MattesNormalizedMutualInformationImageToImageMetric     Self;
  ...
  itkTypeMacro(MattesNormalizedMutualInformationImageToImageMetric,
               ImageToImageMetric);
...
protected:
  ...
  virtual ~MattesNormalizedMutualInformationImageToImageMetric();
...
private:
  ...
  MattesNormalizedMutualInformationImageToImageMetric(const Self &);
  // purposely not implemented
...
#include "itkMattesNormalizedMutualInformationImageToImageMetric.hxx"
#endif

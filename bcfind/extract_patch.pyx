...
@cython.boundscheck(False)
@cython.wraparound(False)
def preprocess_2d_mean_std(np.ndarray[DTYPE_t, ndim=3] tensor, Py_ssize_t z0, int extramargin, int size_patch, int speedup, np.ndarray[DTYPE_t, ndim=1] mean, np.ndarray[DTYPE_t, ndim=1] std):
